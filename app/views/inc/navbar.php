...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    ...
    <a href="index.php" class="flex items-center">
        ...
        <div class="flex items-center">
            <a href="tel:5541251234" class="mr-6 text-sm  text-gray-500 dark:text-white hover:underline"><?php echo $patient['Username'];?></a>
            <a href="http://localhost/drug_dispensary/app/views/Patient/index.php?logout=<?php echo $patientId; ?>" class="text-sm  text-red-600 dark:text-red-500 hover:underline">Logout</a>
        </div>
    </div>
</nav>
