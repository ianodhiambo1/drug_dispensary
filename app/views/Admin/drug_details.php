...
<head>
    ...
    <title><?php foreach($drugs as $drug): echo $drug['DrugName'];?></title>
</head>
<body>
<div class="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">

  <div class="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
    <img class="w-full" alt="image of a girl posing" src="<?php echo $drug['ImageUrl'];?>" />
  </div>
  <div class="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
    ...
    <div class="py-4 border-b border-gray-200 flex items-center justify-between">
      ...
      <div class="flex items-center justify-center">
        <p class="text-sm leading-none text-gray-600 "><?php echo $drug['Category'];?></p>
    ...
    <div class="py-4 border-b border-gray-200 flex items-center justify-between">
      <p class="text-base leading-4 text-gray-800 ">Price</p>
      <div class="flex items-center justify-center">
        <p class="text-sm leading-none text-gray-600  mr-3"><?php echo $drug['Price'];?></p>
    ...
    <button class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-base flex items-center justify-center leading-none text-white bg-gray-800 w-full py-4 hover:bg-gray-700 focus:outline-none">
      <svg class="mr-3 text-white" width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div>
      ...
      <p class="md:w-96 text-base leading-normal text-gray-600  mt-4">Category: <?php echo $drug['Category'];?></p>
    </div>
    <div>
      <div class="border-t border-b py-4 mt-7 border-gray-200">
        ...
        <div class="hidden pt-4 text-base leading-normal pr-12 mt-4 text-gray-600 " id="sect">You will be responsible for paying for your own shipping costs for returning your item. Shipping costs are nonrefundable</div>
      </div>
    </div>
    <div>
      <div class="border-b py-4 border-gray-200">
        ...
        <div class="hidden pt-4 text-base leading-normal pr-12 mt-4 text-gray-600 " id="sect">If you have any questions on how to return your item to us, contact us.</div>
      </div>
    </div>
  </div>
</div>
